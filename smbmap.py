...
class SMBMap():
    ...
    def get_version(self, host):
        ...
        print("[+] {}:{} is running {} (name:{}) (domain:{}) SMB signing required: {}".format(host, 445, self.smbconn[host].getServerOS(), self.smbconn[host].getServerName(), domain, self.smbconn[host].isSigningRequired()))
